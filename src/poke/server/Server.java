...
public class Server {
	...
	protected StoragebeatManager storageMgr;
	...
	private void startManagers() {
		...
		// create manager for handling image storage task
		storageMgr = StoragebeatManager.initManager(conf);
	...
	public static void main(String[] args) {
		...
		try {
			...
			Server.logger.info("Local Database initialized successfully");
			
		} catch (ClassNotFoundException e) {
			Server.logger.error("Error while initializing database. Have you included jar and created database?");
			e.printStackTrace();
		} catch (SQLException e) {
			Server.logger.error("Error while initializing database");
			e.printStackTrace();
		}
		...
		if(ClusterDBServiceImplementation.isInterClusterImplementation()) {
			try {
				...
				Server.logger.info("Cluster Shared Database initialized successfully");
