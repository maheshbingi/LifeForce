...
public class HeartbeatManager extends Thread {
	...
	static final int sHeartRate = 3000; // msec
	...
	/**
	 * exposing incomingHB queues to other classes
	 * 
	 * @return
	 */
	...
	/**
	 *  exposing outgoingHB queues to other classes
	 * 
	 * @return
	 */
	...
	public void removeAdjacentNode(int nodeId){
		if(incomingHB.containsKey(nodeId)){
			incomingHB.remove(nodeId);
			logger.info("Disconnected Node : " + nodeId );
		}
	}
	...
	public void removeFromOutgoingHB(Channel key) {
		this.outgoingHB.remove(key);
	}
}
