...
_NETWORK_NETWORKACTION = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CONNECTME', index=3, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CREATEMAP', index=4, number=55,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ANNOUNCE', index=5, number=56,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SHUTDOWN', index=6, number=999,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_NETWORK = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='networkRecoveryData', full_name='Network.networkRecoveryData', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NETWORKRECOVERYDATA = _descriptor.Descriptor(
  name='NetworkRecoveryData',
  full_name='NetworkRecoveryData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='nodeId', full_name='NetworkRecoveryData.nodeId', index=0,
      number=1, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='host', full_name='NetworkRecoveryData.host', index=1,
      number=2, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='port', full_name='NetworkRecoveryData.port', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mgmtport', full_name='NetworkRecoveryData.mgmtport', index=3,
      number=4, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='isStorageNode', full_name='NetworkRecoveryData.isStorageNode', index=4,
...
_CHECKSTORAGEFLAG = _descriptor.Descriptor(
  name='CheckStorageFlag',
  full_name='CheckStorageFlag',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='isStorageFlag', full_name='CheckStorageFlag.isStorageFlag', index=0,
...
_MGMTHEADER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ipAddress', full_name='MgmtHeader.ipAddress', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='port', full_name='MgmtHeader.port', index=5,
      number=10, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MANAGEMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='storage_flag', full_name='Management.storage_flag', index=9,
      number=10, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='storagebeat', full_name='Management.storagebeat', index=10,
...
_PHOTOPAYLOAD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='responseMessage', full_name='PhotoPayload.responseMessage', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STORAGEBEAT = _descriptor.Descriptor(
  name='Storagebeat',
  full_name='Storagebeat',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='time_ref', full_name='Storagebeat.time_ref', index=0,
...
_NETWORK.fields_by_name['networkRecoveryData'].message_type = _NETWORKRECOVERYDATA
...
_MANAGEMENT.fields_by_name['storage_flag'].message_type = _CHECKSTORAGEFLAG
_MANAGEMENT.fields_by_name['storagebeat'].message_type = _STORAGEBEAT
...
DESCRIPTOR.message_types_by_name['NetworkRecoveryData'] = _NETWORKRECOVERYDATA
DESCRIPTOR.message_types_by_name['CheckStorageFlag'] = _CHECKSTORAGEFLAG
...
DESCRIPTOR.message_types_by_name['Storagebeat'] = _STORAGEBEAT
...
class NetworkRecoveryData(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _NETWORKRECOVERYDATA

  # @@protoc_insertion_point(class_scope:NetworkRecoveryData)

class CheckStorageFlag(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _CHECKSTORAGEFLAG
...
class Storagebeat(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _STORAGEBEAT
